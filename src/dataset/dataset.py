...
from src.utils.utils import load_annotations_charadessta, load_annotations_tacos
    ...
    * TACoS
    ...
    def __getitem__(self, idx):
        ...
        resampled_feature, ori_nframes = resample(
            ...
            ).squeeze(1).squeeze(1), target_length=self.config[self.dataset_name]["video_feature_len"]
        )
